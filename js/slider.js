...
const module = {
    ...
    renderBlocks() {
        ...
        document.querySelectorAll('.slider-item').forEach((element) => element.appendChild(this.generateElement('div','card-image','')).appendChild(this.generateElement('img', '', '')).setAttribute('src', '/img/img.png'))
        document.querySelectorAll('.slider-item').forEach((element) => element.appendChild(this.generateElement('a', 'link', '<img src="/img/linkArrow.svg" alt="arrow">')).setAttribute('href', '#'))
